...
# Setup a 2 row by 2 column ploting area
par(mfrow = c(2,2))

# Top left plot 
with(energyUsageData,plot(dateTime,Global_active_power,ylab = "Global Active Power",type = "l",xlab = ""))

# Top right plot
with(energyUsageData,plot(dateTime,Voltage,ylab = "Voltage",type = "l"))
...
# Bottom right plot
with(energyUsageData,plot(dateTime,Global_reactive_power,ylab = "Global_reactive_power",type = "l",xlab = "datetime"))
dev.off()